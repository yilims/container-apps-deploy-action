...
| `buildEnvironmentVariables`| No      | A list of environment variable(s) used to configure the Buildpacks for image build. Space-separated values in 'key=value' format. Empty string to clear existing values. |
